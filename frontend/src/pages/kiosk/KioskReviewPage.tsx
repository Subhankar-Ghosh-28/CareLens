        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-5 rounded-3xl bg-white border border-slate-200 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-700 leading-relaxed font-medium">
              {clinicalSummary?.chiefComplaint || 'Chest discomfort with mild sweating for 2 days. Occasional radiating pain to left shoulder.'}
            </p>
            <div className="text-[11px] text-slate-500 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
              HPI: {clinicalSummary?.historyOfPresentIllness?.substring(0, 140) || 'Patient reports episodic retrosternal pressure...'}...
            </div>
          </div>
