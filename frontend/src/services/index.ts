...
import { BackendClinicalHistoryService } from './backendClinicalHistoryService';
...
export const clinicalHistoryService: IClinicalHistoryService = new BackendClinicalHistoryService();
